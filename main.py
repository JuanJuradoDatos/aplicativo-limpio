...
import torch
from ultralytics.nn.tasks import DetectionModel  # <- Import necesario para autorizar clase

# Registrar DetectionModel como seguro si se usa torch.load por dentro de YOLO
